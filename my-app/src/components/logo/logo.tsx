...
export default function AnimatedLogo({ size = 58, className }: AnimatedLogoProps) {
  return (
    <div
      className={className}
      style={{
    ...
    >
      <style>{`
        ...
        /* Hide the specific white light-theme AB glow stroke by default (Dark Mode) */
        .light-theme-ab-glow {
          display: none;
        }

        /* Show the clean white glow around letters ONLY in Light Theme */
        :global(html[data-theme='light']) .light-theme-ab-glow,
        :global(.light) .light-theme-ab-glow,
        [data-theme='light'] .light-theme-ab-glow {
      ...
      >
        <defs>
          ...
          {/* Clean High-Contrast Outer Stroke Filter for Light Theme AB Glow */}
          <filter id="f-white-glow" x="-20%" y="-20%" width="140%" height="140%">
          ...
          {/* FIXED: Locked to hex-dark blue colors so it remains dark and crisp under light theme */}
          ...
          <radialGradient id="g-ring" cx="50%" cy="50%" r="50%">
            <stop offset="0%"   stopColor="var(--accent-color, #00ffff)" stopOpacity="0.6"/>
            <stop offset="100%" stopColor="var(--accent-color, #00ffff)" stopOpacity="0"/>
          </radialGradient>
          <linearGradient id="g-ab" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%"   stopColor="var(--accent-color, #00ffff)"/>
            <stop offset="44%"  stopColor="var(--text-bright, #ddf4ff)"/>
            <stop offset="100%" stopColor="var(--secondary-accent, #ff0099)"/>
          </linearGradient>
          ...
          <pattern id="p-scan" x="0" y="0" width="500" height="5" patternUnits="userSpaceOnUse">
            <line x1="0" y1="0" x2="500" y2="0" stroke="var(--accent-color, #00e5ff)" strokeWidth="0.4" opacity="0.042"/>
          </pattern>
          <pattern id="p-hc" x="0" y="0" width="18" height="15.6" patternUnits="userSpaceOnUse">
            <polygon points="9,1 16,4.5 16,11.1 9,14.6 2,11.1 2,4.5"
              fill="none" stroke="var(--accent-color, #00e5ff)" strokeWidth="0.28" opacity="0.24"/>
          </pattern>
        </defs>

        {/* ══ DEEP AURA ══ */}
        <polygon points={outerHex} fill="none" stroke="var(--secondary-accent, #8800ff)" strokeWidth="60"
          opacity="0.06" filter="url(#f-aura)">
          <animate attributeName="opacity" values="0.04;0.1;0.04" dur="4.5s" repeatCount="indefinite"/>
        </polygon>
        <polygon points={outerHex} fill="none" stroke="var(--accent-color, #00ffff)" strokeWidth="30"
        ...
        {/* ══ RING SYSTEM ══ */}
        <g className="r3">
          <circle cx="250" cy="250" r="247" fill="none" stroke="var(--accent-color, #00ffff)"
            strokeWidth="1.6" strokeDasharray="194 68" opacity="0.38" filter="url(#f-xs)"/>
        </g>
        <g className="r2">
          <circle cx="250" cy="250" r="255" fill="none" stroke="var(--secondary-accent, #ff0099)"
            strokeWidth="1" strokeDasharray="36 228" opacity="0.32" filter="url(#f-xs)"/>
        </g>
        <g className="r1">
          <circle cx="250" cy="250" r="232" fill="none" stroke="var(--accent-color, #00ffff)"
        ...
        <g className="r4">
          <circle cx="250" cy="250" r="241" fill="none" stroke="var(--secondary-accent, #8800ff)"
        ...
        <rect x="68" y="-35" width="364" height="35" fill="var(--accent-color, #00ffff)" clipPath="url(#hx)" opacity="0.028">
        ...
        <g clipPath="url(#hx)" filter="url(#f-sm)">
          <line x1="318" y1="40"  x2="432" y2="218" stroke="var(--secondary-accent, #ff0099)" strokeWidth="1.6" opacity="0.88"/>
          <line x1="342" y1="40"  x2="432" y2="246" stroke="var(--secondary-accent, #ff0099)" strokeWidth="0.75" opacity="0.45"/>
          <line x1="68"  y1="260" x2="180" y2="460" stroke="var(--secondary-accent, #ff0099)" strokeWidth="1.6" opacity="0.6"/>
          <line x1="68"  y1="236" x2="160" y2="460" stroke="var(--secondary-accent, #ff0099)" strokeWidth="0.75" opacity="0.32"/>
        </g>

        {/* ══ ENERGY FILAMENTS ══ */}
        {filaments.map((f, i) => (
          <path key={i} d={f.d}
            stroke="var(--accent-color, #00ffff)" fill="none" strokeWidth="0.85"
            strokeDasharray="16 11" clipPath="url(#hx)" opacity="0.42"
            className={f.rev ? "fil-r" : "fil-f"}
            style={{ "--dur": f.dur } as React.CSSProperties}/>
        ))}
        <g fill="var(--accent-color, #00ffff)" filter="url(#f-sm)" opacity="0.75">
        ...
        {/* ══ HEX BORDER LAYERS ══ */}
        <polygon points={innerHex} fill="none" stroke="var(--accent-color, #00ffff)" strokeWidth="0.6" opacity="0.18"/>
        <polygon points={outerHex} fill="none" stroke="var(--secondary-accent, #8800ff)" strokeWidth="5" filter="url(#f-sm)">
          <animate attributeName="opacity" values="0.4;0.72;0.4" dur="4.5s" repeatCount="indefinite"/>
        </polygon>
        <polygon points={outerHex} fill="none" stroke="var(--accent-color, #00ffff)" strokeWidth="1.8" filter="url(#f-xs)">
        ...
        {vertices.map(([vx, vy], i) => (
          <g key={i} filter="url(#f-md)">
            <circle cx={vx} cy={vy} r="11" fill="none" stroke="var(--accent-color, #00ffff)" strokeWidth="0.6" opacity="0.35"/>
            <circle cx={vx} cy={vy} r="5"  fill="var(--accent-color, #00ffff)" opacity="0.95"/>
            <line x1={vx - 10} y1={vy} x2={vx + 10} y2={vy} stroke="var(--accent-color, #00ffff)" strokeWidth="0.9" opacity="0.65"/>
            <line x1={vx} y1={vy - 10} x2={vx} y2={vy + 10} stroke="var(--accent-color, #00ffff)" strokeWidth="0.9" opacity="0.65"/>
          </g>
        ))}

        {/* ══ CORNER BRACKETS ══ */}
        <g stroke="var(--accent-color, #00ffff)" strokeWidth="1.7" fill="none" filter="url(#f-sm)">
        ...
        <g fill="var(--accent-color, #00ffff)" filter="url(#f-sm)">
        ...
        <g fill="var(--secondary-accent, #ff0099)" filter="url(#f-xs)" opacity="0.7">
        ...
        <line x1="148" y1="197" x2="352" y2="197" stroke="var(--accent-color, #00ffff)" strokeWidth="0.7" opacity="0.3"/>
        <line x1="148" y1="318" x2="352" y2="318" stroke="var(--accent-color, #00ffff)" strokeWidth="0.7" opacity="0.3"/>
        <g stroke="var(--accent-color, #00ffff)" strokeWidth="1.5" filter="url(#f-xs)">
        ...
        <text x="157" y="190" fontFamily="'Orbitron',monospace" fontSize="7"
          fill="var(--accent-color, #00ffff)" opacity="0.42" letterSpacing="1">SYS.OK</text>
        <text x="343" y="190" fontFamily="'Orbitron',monospace" fontSize="7"
          fill="var(--secondary-accent, #ff0099)" opacity="0.42" letterSpacing="1" textAnchor="end">v2.4.1</text>
        <text x="157" y="333" fontFamily="'Orbitron',monospace" fontSize="7"
          fill="var(--accent-color, #00ffff)" opacity="0.42" letterSpacing="1">NET::OK</text>
        <text x="343" y="333" fontFamily="'Orbitron',monospace" fontSize="7"
          fill="var(--secondary-accent, #ff0099)" opacity="0.42" letterSpacing="1" textAnchor="end">0xFF42</text>

        {/* ══ CENTRAL ENERGY SYSTEM ══ */}
        <circle cx="250" cy="250" r="28" fill="none" stroke="var(--accent-color, #00ffff)"
        ...
        <circle cx="250" cy="250" r="14" fill="none" stroke="var(--accent-color, #00ffff)"
        ...
        <line x1="250" y1="204" x2="250" y2="298"
          stroke="var(--secondary-accent, #ff0099)" strokeWidth="1.4" opacity="0.55" filter="url(#f-sm)">
          <animate attributeName="opacity" values="0.45;0.75;0.45" dur="4s" repeatCount="indefinite"/>
        </line>

        {/* ══ "AB" — TEXT LAYER & WHITE OUTLINE GLOW FOR LIGHT THEME ══ */}

        {/* CLEAN WHITE GLOW LAYER: Traces the exact shape of AB, only active in light theme */}
        <text className="light-theme-ab-glow" x="250" y="298" fontFamily="'Orbitron',monospace" fontWeight="900" fontSize="136"
          textAnchor="middle" fill="none" stroke="#ffffff" strokeWidth="10" filter="url(#f-white-glow)" opacity="0.95">
          AB
        ...
        <text x="244" y="298" fontFamily="'Orbitron',monospace" fontWeight="900" fontSize="136"
          textAnchor="middle" fill="var(--accent-color, #00ffff)" opacity="0.48" filter="url(#f-chroma)">
          AB
          <animateTransform attributeName="transform" type="translate" additive="sum"
        ...
        <text x="256" y="298" fontFamily="'Orbitron',monospace" fontWeight="900" fontSize="136"
          textAnchor="middle" fill="var(--secondary-accent, #ff0099)" opacity="0.38" filter="url(#f-chroma)">
          AB
          <animateTransform attributeName="transform" type="translate" additive="sum"
            values="0 0;0 0;11 -1;0 0;0 0" dur="8s"
            keyTimes="0;0.81;0.855;0.89;1" repeatCount="indefinite"/>
        ...
        {/* ══ "PORTFOLIO" ══ */}
        <g filter="url(#f-xs)">
          <rect x="150" y="329.5" width="20" height="1.4" fill="var(--secondary-accent, #ff0099)" opacity="0.55"/>
          <rect x="330" y="329.5" width="20" height="1.4" fill="var(--secondary-accent, #ff0099)" opacity="0.55"/>
        </g>
        <text x="250" y="337" fontFamily="'Orbitron',monospace" fontWeight="400" fontSize="10"
          textAnchor="middle" fill="var(--accent-color, #00ffff)" opacity="0.62" letterSpacing="6">PORTFOLIO</text>

        {/* ══ GLITCH STRIPS ══ */}
        <g clipPath="url(#hx)">
          <rect x="148" y="241" width="204" height="9" fill="var(--accent-color, #00ffff)" opacity="0">
            <animate attributeName="opacity"
              values="0;0;0;0.42;0;0" dur="8s"
              keyTimes="0;0.79;0.82;0.855;0.89;1" repeatCount="indefinite"/>
          </rect>
          <rect x="148" y="272" width="128" height="5" fill="var(--secondary-accent, #ff0099)" opacity="0">
            <animate attributeName="opacity"
        ...
        {/* ══ POWER SURGE FLASH ══ */}
        <polygon points={outerHex} fill="var(--accent-color, #00ffff)" clipPath="url(#hx)" opacity="0">
          <animate attributeName="opacity"
            values="0;0;0;0;0.08;0.04;0" dur="9s"
            keyTimes="0;0.87;0.89;0.9;0.91;0.93;0.96" repeatCount="indefinite"/>
        </polygon>
        <circle cx="250" cy="250" r="140" fill="none" stroke="var(--accent-color, #00ffff)"
