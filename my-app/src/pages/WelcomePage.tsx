...
// // ─── HIGH-QUALITY PLANET RENDERING (Rich Backlight + Dynamic Rings) ───────────
...
//   // 3. Render Solid Spherical Body (Textured, shadow terminator, highlight edge)
//   ctx.save();
//   ctx.beginPath();
...
//   // Heavy multi-tiered background star particles (increased star count for immersion!)
//   const stars: Star[] = [];
...
//   // Foreground Giant Celestial Planet from reference
...
//   // Two distant orbital sister worlds
...
// export function CosmoBackground({ children }: { children?: React.ReactNode }) {
...
// // ─── LOGIN & MAIN PAGE APPARATUS ──────────────────────────────────────────────
// export default function App() {
//   const navigate = useNavigate();
//   const [bootStage, setBootStage] = useState<'terminal' | 'login'>('terminal');
...
//   const bootLogs = [
//     '🛰️ INITIALIZING COGNITIVE INTERFACE GRID...',
//     '🌌 CALCULATING DEEP SECTOR PARALLAX VECTORS...',
//     '🔥 DEPLOYING EXOPLANET HIGH-GLOW CORONA SHADOW...',
//     '⚡ TRANSMITTING THROTTLE DECRYPTS FROM SECTOR 9...',
//     '🧠 ALL MEMORY PARTITIONS VERIFIED [SECURE_CORE]...',
//     '🇫🇮 HELSINKI COMM TRANSCEIVER ALIGNMENT // YHTEYS OK!',
//     '🌟 LOADING COSMO STARS AND FARAWAY GAS CLOUDS...',
//     '🔓 READY. ENGAGING AUTHENTICATOR MODULE...'
//   ];
...
//         setTimeout(() => setBootStage('login'), 1200);
//       }
//     }, 350);
...
//   const handleAccessGrant = (e: React.FormEvent) => {
//     e.preventDefault();
//     // Seamless routing to the dashboard path
//     navigate('/dashboard');
//   };

//   return (
//     <div className="relative w-full h-screen bg-[#020108] overflow-hidden font-sans select-none">
//       {/* We are dropping our reusable background context here */}
//       <CosmoBackground>
//         <div className="w-full h-full flex flex-col items-center justify-center relative">

//           {/* Header Title with floating bounce animation */}
//           <div className="absolute top-[8%] text-center pointer-events-none animate-fade-down duration-1000">
//             <h3 className="text-[10px] tracking-[8px] text-pink-400 font-bold uppercase mb-2 drop-shadow-[0_0_12px_rgba(255,100,150,0.5)]">
//               STELLAR GATEWAY ACCESS
//             </h3>
//             <h1 className="text-3xl md:text-4xl font-extrabold tracking-[6px] text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/40 uppercase">
//               WELCOME TO YOUR PORTAL
//             </h1>
//           </div>

//           {/* BOOTING STAGE TERMINAL */}
//           {bootStage === 'terminal' && (
//             <div className="w-full max-w-[500px] p-8 bg-black/60 border border-pink-500/20 rounded-2xl shadow-[0_30px_80px_rgba(0,0,0,0.95)] backdrop-blur-2xl box-border mx-4 animate-pulse-slow">
//               <div className="flex gap-1.5 items-center mb-6 border-b border-white/5 pb-3">
//                 <span className="w-2.5 h-2.5 rounded-full bg-[#ff5f56]" />
//                 <span className="w-2.5 h-2.5 rounded-full bg-[#ffbd2e]" />
//                 <span className="w-2.5 h-2.5 rounded-full bg-[#27c93f]" />
//                 <span className="ml-3 text-[10px] text-white/40 tracking-[2.5px] font-mono">SYS_CORE_TELEMETRY</span>
//               </div>
...
//                     key={index}
//                     className={`${
//                       index === 5 ? 'text-pink-400 font-semibold' : index === 6 ? 'text-cyan-400' : 'text-white/70'
//                     }`}
//                   >
//                     {log}
//                   </div>
//                 ))}
//                 <span className="w-2.5 h-4 bg-pink-400 inline-block animate-ping mt-0.5" />
//               </div>
//             </div>
//           )}

//           {/* INTERACTIVE PREMIUM GLASS CONTAINER */}
//           {bootStage === 'login' && (
//             <form
//               onSubmit={handleAccessGrant}
//               className={`w-full max-w-[420px] bg-gradient-to-br from-[rgba(22,12,34,0.65)] to-[rgba(6,3,12,0.75)] border border-white/10 rounded-3xl p-10 backdrop-blur-3xl flex flex-col transition-all duration-700 mx-4 ${
//                 isHovered
//                   ? 'shadow-[0_50px_100px_rgba(0,0,0,0.95),0_0_40px_rgba(255,100,150,0.15)] scale-[1.01]'
//                   : 'shadow-[0_45px_90px_rgba(0,0,0,0.85)]'
//               }`}
//             >
//               <div className="text-center mb-9">
//                 <h2 className="text-2xl font-black tracking-[4px] bg-gradient-to-r from-pink-400 via-white to-cyan-400 bg-clip-text text-transparent uppercase mb-2">
//                   DECRYPT CREDENTIALS
//                 </h2>
//                 <p className="text-xs text-white/40 tracking-wide">
//                   Verify cryptographic identity to establish connection
//                 </p>
//               </div>

//               <div className="flex flex-col gap-6 mb-9">
//                 <div className="flex flex-col gap-2">
//                   <label className="text-[10px] text-pink-400 tracking-[2.5px] font-bold">OPERATOR IDENTIFIER</label>
//                   <input
//                     type="text"
//                     value={username}
//                     onChange={(e) => setUsername(e.target.value)}
//                     placeholder="Enter Grid Handle..."
//                     className="w-full bg-black/60 border border-white/10 rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-pink-500/50 transition-colors placeholder:text-white/20"
//                     required
//                   />
//                 </div>

//                 <div className="flex flex-col gap-2">
//                   <label className="text-[10px] text-cyan-400 tracking-[2.5px] font-bold">DECRYPTION CIPHER KEY</label>
//                   <input
//                     type="password"
//                     value={password}
//                     onChange={(e) => setPassword(e.target.value)}
//                     placeholder="•••••••••••••"
//                     className="w-full bg-black/60 border border-white/10 rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-cyan-500/50 transition-colors"
//                     required
//                   />
//                 </div>
//               </div>
...
//                 className={`w-full py-4 rounded-xl font-bold tracking-[3px] uppercase text-xs transition-all duration-300 cursor-pointer ${
//                   isHovered
                    // ? 'bg-gradient-to-r from-pink-500 to-cyan-400 text-white shadow-[0_0_35px_rgba(255,100,150,0.4)]'
//                     : 'bg-white/5 text-white/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]'
//                 }`}
//               >
...
export default function App() {
  ...
  // 🔒 Dynamic login interface status states
  ...
  // 🔑 Updated: Dynamic Auth loop querying your Disk D bridge server!
  const handleAccessGrant = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        // Securely store the dynamic session token
        localStorage.setItem('sys_session_token', data.token);

        // Success route dispatch
        navigate('/dashboard');
      } else {
        setErrorMsg(data.message || 'CIPHER MATCH FAILURE');
        setPassword(''); // Clear password field on lock out
      }
    } catch (err) {
      console.error(err);
      setErrorMsg('SYS_ERROR: BRIDGE_SERVER_OFFLINE (Port 5000)');
    } finally {
          ...
          {bootStage === 'login' && (
            ...
            >
              ...
              <div className="flex flex-col gap-6 mb-7">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full bg-black/60 border border-white/10 rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-pink-500/50 transition-colors placeholder:text-white/20 disabled:opacity-50"
                    required
                  />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    placeholder="•••••••••••••"
                    disabled={isSubmitting}
                    className="w-full bg-black/60 border border-white/10 rounded-xl px-4 py-3.5 text-white text-sm outline-none focus:border-cyan-500/50 transition-colors disabled:opacity-50"
                    required
                  />
                </div>
              </div>

              {/* 🛑 Cyberpunk Error Message outputting server feedback */}
              {errorMsg && (
                <div className="text-center font-mono text-[11px] text-red-400 tracking-wider bg-red-950/20 border border-red-500/30 rounded-lg py-2.5 px-3 mb-6 animate-pulse">
                  ⚠️ {errorMsg}
                </div>
              )}
              ...
              <button
                ...
                onMouseEnter={() => setIsHovered(true)}
                onMouseLeave={() => setIsHovered(false)}
                className={`w-full py-4 rounded-xl font-bold tracking-[3px] uppercase text-xs transition-all duration-300 cursor-pointer disabled:opacity-40 disabled:cursor-wait ${
                  isHovered && !isSubmitting
                    ? 'bg-gradient-to-r from-pink-500 to-cyan-400 text-white shadow-[0_0_35px_rgba(255,100,150,0.4)]'
                    : 'bg-white/5 text-white/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]'
                }`}
              >
                {isSubmitting ? 'DECRYPTING SECURE MATRIX...' : 'INITIALIZE VERIFICATION'}
              </button>
            </form>
          )}
